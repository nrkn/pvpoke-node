...
export function getCalculatedStats( baseStats: Stats
                                  , ivs:       Stats
                                  , level:     number
                                  ):           Stats {
...
export function getCp( baseStats: Stats, ivs: Stats, cpm: number ): number {
  const cp = Math.floor(
    (
...
export function getCpFromLevel( baseStats: Stats
                              , ivs:       Stats
                              , level:     number
                              ):           number {
  return getCp( baseStats, ivs, getCpm( level ) );
}
